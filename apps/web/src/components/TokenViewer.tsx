  ...
  const groups = [
    {
      ...
      tokens: [
        ...
        { name: "Secondary Light", value: theme.palette.secondary.light, token: "secondary.light" },
        { name: "Secondary Dark", value: theme.palette.secondary.dark, token: "secondary.dark" },
      ],
    },
    {
      label: "Semantic",
      tokens: [
        ...
        { name: "Success Light", value: theme.palette.success.light, token: "success.light" },
        { name: "Warning", value: theme.palette.warning.main, token: "warning.main" },
        { name: "Warning Light", value: theme.palette.warning.light, token: "warning.light" },
        { name: "Error", value: theme.palette.error.main, token: "error.main" },
        { name: "Error Light", value: theme.palette.error.light, token: "error.light" },
        { name: "Info", value: theme.palette.info.main, token: "info.main" },
        { name: "Info Light", value: theme.palette.info.light, token: "info.light" },
      ],
    },
    {
      label: "Surface",
      tokens: [
        ...
        { name: "Text Disabled", value: theme.palette.text.disabled, token: "text.disabled" },
        { name: "Divider", value: theme.palette.divider, token: "divider" },
      ],
    },
    {
      label: "Grey",
      tokens: [
        { name: "50", value: theme.palette.grey[50], token: "grey.50" },
        { name: "100", value: theme.palette.grey[100], token: "grey.100" },
        { name: "200", value: theme.palette.grey[200], token: "grey.200" },
        { name: "300", value: theme.palette.grey[300], token: "grey.300" },
        { name: "400", value: theme.palette.grey[400], token: "grey.400" },
        { name: "500", value: theme.palette.grey[500], token: "grey.500" },
        { name: "600", value: theme.palette.grey[600], token: "grey.600" },
        { name: "700", value: theme.palette.grey[700], token: "grey.700" },
        { name: "800", value: theme.palette.grey[800], token: "grey.800" },
        { name: "900", value: theme.palette.grey[900], token: "grey.900" },
      ],
    },
    {
      label: "Action",
      tokens: [
        { name: "Hover", value: theme.palette.action.hover, token: "action.hover" },
        { name: "Selected", value: theme.palette.action.selected, token: "action.selected" },
        { name: "Disabled", value: theme.palette.action.disabled, token: "action.disabled" },
        { name: "Disabled BG", value: theme.palette.action.disabledBackground, token: "action.disabledBackground" },
      ],
    },
  ];
